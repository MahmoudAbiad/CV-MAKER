...
async def on_shutdown() -> None:
    # ملاحظة مهمة: لا نستدعي bot.delete_webhook() هنا إطلاقاً.
    # Render يشغّل النسخة الجديدة أولاً (تُسجّل الـ webhook بنجاح)
    # ثم يوقف النسخة القديمة بعدها (zero-downtime deploy).
    # لو مسحنا الـ webhook هنا، هنمسح تسجيل النسخة الجديدة اللي شغالة
    # فعلاً، وتليجرام يفضل من غير أي webhook بعد كل ديبلوي.
